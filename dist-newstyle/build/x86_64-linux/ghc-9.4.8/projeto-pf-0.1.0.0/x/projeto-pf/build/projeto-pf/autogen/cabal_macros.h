...
/* package projeto-pf-0.1.0.0 */
#ifndef VERSION_projeto_pf
#define VERSION_projeto_pf "0.1.0.0"
#endif /* VERSION_projeto_pf */
#ifndef MIN_VERSION_projeto_pf
#define MIN_VERSION_projeto_pf(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_projeto_pf */
...
#define CURRENT_COMPONENT_ID "projeto-pf-0.1.0.0-inplace-projeto-pf"
